...
transExpr x = case x of
  ...
  Syntax.Normal.Abs.Print expr1 expr2 -> failure x
  Syntax.Normal.Abs.Assignment ident expr1 expr2 -> failure x
  Syntax.Normal.Abs.Abstraction ident expr -> failure x
  Syntax.Normal.Abs.LazyAbstraction ident expr -> failure x
  Syntax.Normal.Abs.Application expr exprs -> failure x
  ...
  Syntax.Normal.Abs.ConstInteger integer -> failure x
